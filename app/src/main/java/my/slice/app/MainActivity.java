...
public class MainActivity extends AppCompatActivity {
    ...
    private String token = "BQDArgmReE_iqcguolbql5UnUi5uTQJUR-syDx8hIhIOeeU4TUW_GeWOBaUCiwak2bZmxrN8ybsonIhm6el9jE76ICzSJRV0q0JyLPiDK69sBEOVhfAcXBGqQBFjBNiMGvmDdbsHi4Rc0fHN";
    AuthorizationRequest.Builder builder =
            new AuthorizationRequest.Builder(CLIENT_ID, AuthorizationResponse.Type.TOKEN, REDIRECT_URI);

    // Getting more playlists fields
    int offset = 0;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            switch (response.getType()) {
                ...
                default:
                    // Handle other cases
                    Snackbar.make(playlistRecycler, "Trouble connecting to Spotify", Snackbar.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        playlistAdapter = new RecyclerView.Adapter<FindPlaylist>() {
            ...
            public void onBindViewHolder(@NonNull FindPlaylist holder, int position) {
                ...
                if (!model.imageUrl.equals("")) Picasso.get().load(model.imageUrl).into(holder.image);
            ...
            spotify.getMyPlaylists(new SpotifyCallback<Pager<PlaylistSimple>>() {
                ...
                public void success(Pager<PlaylistSimple> playlistSimplePager, Response response) {
                    ...
                    for (PlaylistSimple playlistSimple : playlistSimplePager.items) {
                        ...
                        String url = "";
                        try {
                            url = playlistSimple.images.get(0).url;
                        }
