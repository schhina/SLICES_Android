...
public class SongActivity extends AppCompatActivity {
    ...
    // Time Setting stuff
    private AlertDialog.Builder timeSettingDialogBuilder;
    private AlertDialog timeSettingDialog;
    private int timeID;
    String key = "time_setting";
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            if (uri != null && model != null && uri.equals(model.uri)) menu.findItem(R.id.action_play_song).setIcon(ContextCompat.getDrawable(getApplicationContext(), R.drawable.ic_baseline_pause_24));
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarLayout appbar = findViewById(R.id.song_app_bar);
        ...
        // Get time setting
        SharedPreferences pref = this.getSharedPreferences("my.slice.app", Context.MODE_PRIVATE);
        timeID = pref.getInt(key, 0);
    ...
    protected void onStart() {
        ...
        sliceAdapter = new RecyclerView.Adapter<FindSlice>() {
            ...
            public void onBindViewHolder(@NonNull FindSlice holder, int position) {
                ...
                // Init Edit texts
                if (timeID == 0 || timeID == 1) {
                    // If it doesn't use minutes
                    holder.leftMinutes.setVisibility(View.INVISIBLE);
                    holder.rightMinutes.setVisibility(View.INVISIBLE);
                    holder.leftColon.setVisibility(View.INVISIBLE);
                    holder.rightColon.setVisibility(View.INVISIBLE);
                    holder.left.setText(convertTimeOne(left/1000.0) + "");
                    holder.right.setText(convertTimeOne(right/1000.0) + "");
                } else{
                    // If it uses minutes
                    holder.leftMinutes.setVisibility(View.VISIBLE);
                    holder.rightMinutes.setVisibility(View.VISIBLE);
                    holder.leftColon.setVisibility(View.VISIBLE);
                    holder.rightColon.setVisibility(View.VISIBLE);
                    double leftSeconds = left/1000.0;
                    double rightSeconds = right/1000.0;
                    int leftMinutes = (int)leftSeconds/60;
                    int rightMinutes = (int)rightSeconds/60;
                    holder.leftMinutes.setText(leftMinutes + "");
                    holder.rightMinutes.setText(rightMinutes + "");
                    System.out.println(leftSeconds % 60);
                    System.out.println(rightSeconds % 60);
                    holder.left.setText(convertTimeTwo(leftSeconds % 60) + "");
                    holder.right.setText(convertTimeTwo(rightSeconds % 60) + "");
                }
                ...
                holder.seekbar.setOnRangeSeekbarChangeListener(new OnRangeSeekbarChangeListener() {
                    ...
                    public void valueChanged(Number minValue, Number maxValue) {
                        ...
                        !closeEnough(parseDouble(holder.right.getText().toString()), maxValue.doubleValue())){
                            ...
                            switch (timeID){
                                // Minutes with whole seconds
                                case 2:
                                    holder.leftMinutes.setText(minValue.intValue()/60 + "");
                                    holder.rightMinutes.setText(maxValue.intValue()/60 + "");
                                    holder.left.setText(minValue.intValue()%60 + "");
                                    holder.right.setText(maxValue.intValue()%60 + "");
                                    break;
                                // Whole seconds
                                case 0:
                                    System.out.println(minValue.intValue() + "");
                                    holder.left.setText(minValue.intValue() + "");
                                    holder.right.setText(maxValue.intValue() + "");
                                    break;
                                // Minutes with decimal seconds
                                case 3:
                                    holder.leftMinutes.setText(minValue.intValue()/60 + "");
                                    holder.rightMinutes.setText(maxValue.intValue()/60 + "");
                                    String l = String.format("%.3f", minValue.doubleValue()%60);
                                    String r = String.format("%.3f", maxValue.doubleValue() % 60);
                                    holder.left.setText(l);
                                    holder.right.setText(r);
                                    break;
                                // Decimal Seconds
                                default:
                ...
                holder.left.setOnEditorActionListener(new TextView.OnEditorActionListener() {
                    ...
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        ...
                        // Get the correct chosen value
                        int left;
                        if (timeID == 0 || timeID == 1) {
                            left = (int) (parseDouble(holder.left.getText().toString())*1000);
                        } else{
                            left = parseInt(holder.leftMinutes.getText().toString())*60*1000 + (int) (parseDouble(holder.left.getText().toString())*1000);
                        }
                ...
                // When the right edittext is updated
                holder.right.setOnEditorActionListener(new TextView.OnEditorActionListener() {
                    ...
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        ...
                        int right;
                        if (timeID == 0 || timeID == 1) {
                            right = (int) (parseDouble(holder.right.getText().toString())*1000);
                        } else{
                            right = parseInt(holder.rightMinutes.getText().toString())*60*1000 + (int) (parseDouble(holder.right.getText().toString())*1000);
                        }
                ...
                // Right minutes is updated
                holder.rightMinutes.setOnEditorActionListener(new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                        int right = parseInt(holder.rightMinutes.getText().toString())*60*1000 + (int) (parseDouble(holder.right.getText().toString())*1000);
                ...
                // Left minutes is updated
                holder.leftMinutes.setOnEditorActionListener(new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                        int left = parseInt(holder.leftMinutes.getText().toString())*60*1000 + (int) (parseDouble(holder.left.getText().toString())*1000);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        this.menu = menu;
        boolean update = menu.findItem(R.id.action_play_song) != null;

        if (isPlaying()) if (update) menu.findItem(R.id.action_play_song).setIcon(ContextCompat.getDrawable(this, R.drawable.ic_baseline_pause_24));
        else if (update) menu.findItem(R.id.action_play_song).setIcon(ContextCompat.getDrawable(this, R.drawable.ic_baseline_play_arrow_24));
...
//        }
    ...
    public boolean isPlaying(){
        ...
        return (uri != null && uri.equals(model.uri));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_play_song:
                ...
                if (!isPlaying()){
                    notificationIntent.putExtra("songUri", model.uri);
                    notificationIntent.putExtra("name", model.name);
                    notificationIntent.putExtra("playlistUri", playlistUri);
                    ...
                    isBound = false;
                    menu.findItem(R.id.action_play_song).setIcon(ContextCompat.getDrawable(this, R.drawable.ic_baseline_play_arrow_24));
                }
                return true;
            ...
            case R.id.action_change_time_settings:
                // Open a dialog box
                timeSettingDialogBuilder = new AlertDialog.Builder(new ContextThemeWrapper(this, R.style.myDialog));
                final View popUpView = getLayoutInflater().inflate(R.layout.time_setting_popup, null);
                RadioGroup group = popUpView.findViewById(R.id.time_group);
                Button confirm = popUpView.findViewById(R.id.time_setting_confirm);

                // Retrieve saved time setting
                SharedPreferences pref = this.getSharedPreferences("my.slice.app", Context.MODE_PRIVATE);
                int id = pref.getInt(key, 0);
                ...
                timeSettingDialogBuilder.setView(popUpView);
                timeSettingDialog = timeSettingDialogBuilder.create();
    ...
    // Converts for whole seconds and decimal seconds
    private double convertTimeOne(double sec){
        switch(timeID){
            // Whole seconds
            case 0:
                return (int)sec;
    ...
    // Converst for minutes with whole seconds or decimal seconds
    private double convertTimeTwo(double sec){
        switch(timeID){
            // Whole seconds
            case 2:
                return (int) sec;
    ...
    public static class FindSlice extends RecyclerView.ViewHolder{
        EditText left, right, leftMinutes, rightMinutes;
        TextView leftColon, rightColon;
        Button delete;
        ...
        public FindSlice(@NonNull View itemView) {
            ...
            leftMinutes = itemView.findViewById(R.id.slice_template_left_minutes);
            rightMinutes = itemView.findViewById(R.id.slice_template_right_minute);
            leftColon = itemView.findViewById(R.id.slice_template_left_colon);
            rightColon = itemView.findViewById(R.id.slice_template_right_colon);
